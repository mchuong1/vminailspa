  ...
  return (
    <div id='footer' className={classes.footer}>
      <div className={classes.socialBar}>
        ...
        <PhoneIcon classes={{root: classes.socialIcon}} onClick={() => goToSocial('tel:561.367.1590')}/>
        <MailIcon classes={{root: classes.socialIcon}} onClick={() => goToSocial('mailto:vminailspa@gmail.com')}/>
      </div>
